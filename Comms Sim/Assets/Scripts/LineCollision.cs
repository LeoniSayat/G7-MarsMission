...
public class LineCollision : MonoBehaviour{
    ...
    void LateUpdate() { 
        ...
        // Vector3[] positions = {lineController.startpos,lineController.destpos};
        // List<Vector3> currentPositions = new List<Vector3> {lineController.startpos,lineController.destpos};
        // List<Vector3> currentColliderPoints = CalculateColliderPoints(currentPositions);
